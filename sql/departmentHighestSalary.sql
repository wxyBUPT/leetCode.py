...
SELECT d.Name Department, e.Name Employee, e.Salary FROM Employee e LEFT JOIN
Department d ON d.Id = e.DepartmentId AND
(Department, e.Salary) in (SELECT DepartmentId, max(Salary) FROM )
;